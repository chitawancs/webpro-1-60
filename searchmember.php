...
<!-- Sidebar end=============================================== -->
	...
	<a  href="product_detailsmember.php?n=<?php echo $data["pid"];?>"><img src="themes/images/products/<?php echo $data["pphoto"];?>" alt=""/></a >

					<div class="caption">
					  <h5><?php echo $data["pname"];?></h5>
					  <h4 style="text-align:center"><a class="btn" href="product_detailsmember.php?n=<?php echo $data["pid"];?>"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">฿ <?php echo $data["price"];?></a></h4>
					</div>
				  </div>
				</li>
