...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    ...
    <form class="form-inline navbar-search" method="post" action="searchadmin.php" >
...
<!-- Sidebar end=============================================== -->
	...
	<a  href="product_detailsadmin.php?n=<?php echo $data["pid"];?>"><img src="themes/images/products/<?php echo $data["pphoto"];?>" alt=""/></a >

					<div class="caption">
					  <h5><?php echo $data["pname"];?></h5>
					  <h4 style="text-align:center"><a class="btn" href="product_detailsadmin.php?n=<?php echo $data["pid"];?>"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">฿ <?php echo $data["price"];?></a></h4>
					</div>
				  </div>
				</li>
