...
<!-- Sidebar end=============================================== -->
	...
	<div class="alert fade in">
	 ...
	 <div class="alert alert-block alert-error fade in">
		...
		<div class="control-group">
		<label class="control-label" for="mname">Name <sup>*</sup></label>
		<div class="controls">
			<input type="hidden" name="m" value=<?php
			 ...
			 ?>>
		  <input type="text" name="mname" value="<?php
					 $sql = "SELECT * FROM member WHERE email = '$_SESSION[email]' " ;
					 $objQuery = mysqli_query($conn,$sql) or die ("Error Query [".$sql."]");
					 $result = $conn->query($sql);
					 while($row = $result->fetch_assoc()) {
	  ...
	  <div class="control-group">
		...
		<div class="controls">
			​<textarea name="address" cols="70" rows="10" ><?php
					 $sql = "SELECT * FROM member WHERE email = '$_SESSION[email]' " ;
					 $objQuery = mysqli_query($conn,$sql) or die ("Error Query [".$sql."]");
					 $result = $conn->query($sql);
					 while($row = $result->fetch_assoc()) {
		...
		<div class="control-group">
			<label class="control-label" for="visa">Visa <sup>*</sup></label>
			<div class="controls">
			  <input type="text" name="visa" value="<?php
						 $sql = "SELECT * FROM member WHERE email = '$_SESSION[email]' " ;
						 $objQuery = mysqli_query($conn,$sql) or die ("Error Query [".$sql."]");
						 $result = $conn->query($sql);
						 while($row = $result->fetch_assoc()) {
